        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @endif
                    <form method="post" action="{{url('admin/editschool')}}" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group"><label class="col-sm-2 control-label">学校名称</label>
                            <div class="col-sm-10"><input readonly  type="text" required value="{{$school->sch_name}}"  name="sch_name" class="form-control"></div>

                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">学校地址</label>
                            <div class="col-sm-10"><input type="text" required value="{{$school->sch_address}}"  name="sch_address" class="form-control"></div>

                        </div>
                        <input type="hidden" name="sch_id" value="{{$school->sch_id}}">
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">学校电话</label>
                            <div class="col-sm-10"><input type="text" required value="{{$school->sch_tel}}"  name="sch_tel" class="form-control"></div>

                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">学校邮箱</label>
                            <div class="col-sm-10"><input type="email" required  value="{{$school->sch_email}}" name="sch_email" class="form-control"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">学校简介</label>
                            <div class="col-sm-10">
                                <textarea id="content" required  name="sch_content">
                                     {{$school->sch_content}}
                                </textarea>
