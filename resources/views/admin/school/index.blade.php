                ...
                @if(Auth::user()->name=='admin')
                    ...
                    <li  class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="{{url('admin/school')}}">学校列表</a></li>
    ...
    <div id="page-wrapper" class="gray-bg sidebar-content" style="height:auto;background-color: white">
        ...
        <div class="mt-20" style="margin-bottom: 50px">
            <table class="table table-border  table-bordered table-hover table-bg table-sort">
                ...
                <th width="200">学校电话</th>
                <th width="200">学校邮箱</th>
                <th width="400">学校简介</th>
...
<script>
    ...
    /*编辑*/
    function school_edit(title,url,w,h){
        layer_show(title,url,w,h);
    }

    function school_show(title,url,w,h){
        layer_show(title,url,w,h);
    }
    ...
    function school_del(id){
        layer.confirm('学校删除须谨慎，确认要删除吗？',function(index){
            $.ajax({
                type: 'POST',
    ...
    $(function(){
        $('.table-sort').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{url('admin/sch/data')}}",
            columns: [
                {data: 'sch_id',name:'sch_id'},
                {data: 'sch_name',name:'sch_name'},
                {data: 'sch_tel',name:'sch_tel'},
                {data: 'sch_email',name:'sch_email'},
                {data: 'sch_content',name:'sch_content'},
