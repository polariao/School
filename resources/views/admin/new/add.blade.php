...
<li class="active">
    ...
    <ul class="nav nav-second-level">
        ...
        <li class="active"><a href="{{url('admin/new/create')}}">添加新闻</a></li>
    </ul>
</li>
</ul>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @endif
                    <form method="post" action="{{url('admin/new')}}" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group"><label class="col-sm-2 control-label">新闻标题</label>
                            <div class="col-sm-10"><input type="text" required  name="n_title" class="form-control"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">新闻内容</label>
                            <div class="col-sm-10">
                                <textarea id="content" required  name="n_content"></textarea>
                            </div>
                        </div>
