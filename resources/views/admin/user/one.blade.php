            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @if(session('msg'))
                     ...
                     @endif
                    <form method="post" action="{{url('admin/use/one')}}" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group"><label class="col-sm-2 control-label">所属学校</label>
                            <div class="col-sm-10">
                                <select required name="sch_name" class="form-control">
                                        <option value="{{$user->sch_name}}">{{$user->sch_name}}</option>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">账号信息:<br/>
                            ...
                            <div class="col-sm-10">
                                <input type="email" required  value="{{$user->email}}" name="email" class="form-control">
                            </div>
