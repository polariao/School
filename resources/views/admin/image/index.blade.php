...
@include('layouts.left_head')
                ...
                <li  class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="{{url('admin/image')}}">图片列表</a></li>
    ...
    <div id="page-wrapper" class="gray-bg sidebar-content" style="height:auto;background-color: white">
        ...
        <div class="mt-20" style="margin-bottom: 50px">
            <table class="table table-border  table-bordered table-hover table-bg table-sort">
                ...
                <th width="200">图片资料</th>
                <th width="100">图片状态</th>
                <th width="200">最后操作时间</th>
                <th width="150">操作</th>
                </tr>
                </thead>
            </table>
...
<script>
    ...
    function status(img_id ,status){
        layer.confirm('图片操作须谨慎，确认吗？',function(index){
            $.ajax({
                type: 'GET',
                url: "{{url('admin/imgstatus?id=')}}"+img_id+'&status='+status,
                dataType: 'json',
    ...
    /*管理员-角色-删除*/
    function img_del(id){
        layer.confirm('图片删除须谨慎，确认要删除吗？',function(index){
            $.ajax({
                type: 'POST',
    ...
    $(function(){
        $('.table-sort').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{url('admin/img/data')}}",
            columns: [
                {data: 'img_id',name:'img_id'},
