...
<li class="active">
    ...
    <ul class="nav nav-second-level">
        ...
        <li class="active"><a href="{{url('admin/sign/create')}}">后台报名</a></li>
    </ul>
</li>
<li>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @if(session('msg'))
                     ...
                     @endif
                    <form method="post" action="{{url('admin/sign')}}" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group"><label class="col-sm-2 control-label">报名学校</label>
                            <div class="col-sm-10">
